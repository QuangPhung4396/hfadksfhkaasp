...
class NetworksService: NSObject {
    ...
    fileprivate func saveDataCommon(_ json: MoDictionary) -> Bool {
        ...
        let isSaved = writeData(time: time, isRating: isRating, extra: extra, userdefaults: user_defaults, version: version)
        if isSaved {
    ...
    @discardableResult
    fileprivate func writeData(time: Date?, isRating: Bool, extra: String?, userdefaults: [MoDictionary], version: Int) -> Bool {
