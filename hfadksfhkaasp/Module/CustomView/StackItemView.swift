...
class StackItemView: UIView {
    ...
    @IBOutlet weak var imgView: PImageView!
    @IBOutlet weak var highlightView: UIView!
    
    private let higlightBGColor = UIColor(rgb: 0x12CDD9)
    ...
    private func configure(_ item: Any?) {
        ...
        self.imgView.tintColorImage = UIColor.white
    ...
    private func updateUI(isSelected: Bool) {
        ...
        UIView.animate(withDuration: 0.4,
            ...
            let color = isSelected ? self.higlightBGColor : .clear
